...
package com.zapps.docsReaderModule.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link com.zapps.docsReaderModule.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link com.zapps.docsReaderModule.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see com.zapps.docsReaderModule.fc.hwpf.usermodel.Shape
 * @see com.zapps.docsReaderModule.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
