...
import com.zapps.docsReaderModule.officereader.filelist.FileDialogAction;
import com.zapps.docsReaderModule.officereader.filelist.FileItem;
import com.zapps.docsReaderModule.officereader.filelist.FileItemAdapter;
import com.zapps.docsReaderModule.officereader.filelist.FileItemView;
import com.zapps.docsReaderModule.officereader.filelist.FileRenameDialog;
import com.zapps.docsReaderModule.officereader.filelist.FileSort;
import com.zapps.docsReaderModule.officereader.filelist.FileSortType;
import com.zapps.docsReaderModule.officereader.filelist.FileToolsbar;
import com.zapps.docsReaderModule.officereader.filelist.NewFolderDialog;
import com.zapps.docsReaderModule.officereader.filelist.SortDialog;
import com.zapps.docsReaderModule.officereader.search.ISearchResult;
import com.zapps.docsReaderModule.officereader.search.Search;
import com.zapps.docsReaderModule.system.FileKit;
import com.zapps.docsReaderModule.system.IControl;
import com.zapps.docsReaderModule.system.dialog.MessageDialog;
import com.zapps.docsReaderModule.system.dialog.QuestionDialog;
    ...
    private void browseTo(File aDirectory) {
        if (aDirectory.isDirectory()) {
            ...
            if (FileKit.instance().isSupport(aDirectory.getName())) {
                ...
                intent.setClass(this, ActivityDocumentReader.class);
                intent.putExtra(DocsReaderConstant.KEY_INTENT_SELECTED_FILE_PATH, aDirectory.getAbsolutePath());
