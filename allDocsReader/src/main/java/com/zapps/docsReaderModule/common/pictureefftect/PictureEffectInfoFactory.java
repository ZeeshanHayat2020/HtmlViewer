 ...
 * 时间:              上午9:08:14
 */
package com.zapps.docsReaderModule.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.zapps.docsReaderModule.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
