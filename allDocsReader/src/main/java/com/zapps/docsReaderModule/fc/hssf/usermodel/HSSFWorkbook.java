...
import com.zapps.docsReaderModule.fc.POIDocument;
import com.zapps.docsReaderModule.fc.codec.DigestUtils;
import com.zapps.docsReaderModule.fc.ddf.EscherBSERecord;
import com.zapps.docsReaderModule.fc.ddf.EscherBitmapBlip;
import com.zapps.docsReaderModule.fc.ddf.EscherBlipRecord;
import com.zapps.docsReaderModule.fc.ddf.EscherRecord;
import com.zapps.docsReaderModule.fc.hssf.OldExcelFormatException;
import com.zapps.docsReaderModule.fc.hssf.formula.FormulaShifter;
import com.zapps.docsReaderModule.fc.hssf.formula.SheetNameFormatter;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.Area3DPtg;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.MemFuncPtg;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.Ptg;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.UnionPtg;
import com.zapps.docsReaderModule.fc.hssf.formula.udf.AggregatingUDFFinder;
import com.zapps.docsReaderModule.fc.hssf.formula.udf.UDFFinder;
import com.zapps.docsReaderModule.fc.hssf.model.DrawingManager2;
...
import com.zapps.docsReaderModule.fc.hssf.model.RecordStream;
import com.zapps.docsReaderModule.fc.hssf.record.AbstractEscherHolderRecord;
...
import com.zapps.docsReaderModule.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import com.zapps.docsReaderModule.fc.hssf.record.LabelRecord;
import com.zapps.docsReaderModule.fc.hssf.record.LabelSSTRecord;
...
import com.zapps.docsReaderModule.fc.hssf.record.RecordFactory;
import com.zapps.docsReaderModule.fc.hssf.record.SSTRecord;
import com.zapps.docsReaderModule.fc.hssf.record.SubRecord;
import com.zapps.docsReaderModule.fc.hssf.record.UnknownRecord;
...
import com.zapps.docsReaderModule.fc.hssf.util.CellReference;
import com.zapps.docsReaderModule.fc.poifs.filesystem.DirectoryNode;
import com.zapps.docsReaderModule.fc.poifs.filesystem.POIFSFileSystem;
import com.zapps.docsReaderModule.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.zapps.docsReaderModule.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements com.zapps.docsReaderModule.fc.ss.usermodel.Workbook
{
     ...
     *        in memory
     * @see com.zapps.docsReaderModule.fc.poifs.filesystem.POIFSFileSystem
...
//            names.add(name);
    ...
    /**
      ...
      * @see com.zapps.docsReaderModule.fc.hssf.record.LabelRecord
      * @see com.zapps.docsReaderModule.fc.hssf.record.LabelSSTRecord
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link com.zapps.docsReaderModule.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(com.zapps.docsReaderModule.fc.ss.usermodel.Sheet sheet)
    {
