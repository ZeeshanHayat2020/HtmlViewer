...
import com.zapps.docsReaderModule.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.zapps.docsReaderModule.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.zapps.docsReaderModule.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see com.zapps.docsReaderModule.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.zapps.docsReaderModule.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.zapps.docsReaderModule.fc.hslf.record.Slide)getSheetContainer();
    }
