...
import com.zapps.docsReaderModule.fc.ss.usermodel.IFont;
 ...
 * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.zapps.docsReaderModule.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(com.zapps.docsReaderModule.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.zapps.docsReaderModule.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == com.zapps.docsReaderModule.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (com.zapps.docsReaderModule.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(com.zapps.docsReaderModule.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == com.zapps.docsReaderModule.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != com.zapps.docsReaderModule.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(com.zapps.docsReaderModule.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
