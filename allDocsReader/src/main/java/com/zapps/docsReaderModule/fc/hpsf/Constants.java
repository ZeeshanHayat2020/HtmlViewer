...
public class Constants {
    ...
    public static final String ACTION_RETRIEVE_FILE_PATH = "ACTION_RETRIEVE_FILE_PATH";

    public static final String TASK_FILE_PATH_ON_PRE_EXECUTE = "TASK_FILE_PATH_ON_PRE_EXECUTE";
