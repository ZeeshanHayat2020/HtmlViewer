 ...
 * 时间:               下午4:23:51
 */
package com.zapps.docsReaderModule.fc.ppt;
...
import com.zapps.docsReaderModule.common.autoshape.ExtendPath;
import com.zapps.docsReaderModule.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.zapps.docsReaderModule.common.bg.BackgroundAndFill;
import com.zapps.docsReaderModule.common.bg.Gradient;
import com.zapps.docsReaderModule.common.bg.LinearGradientShader;
import com.zapps.docsReaderModule.common.bg.RadialGradientShader;
import com.zapps.docsReaderModule.common.bg.TileShader;
import com.zapps.docsReaderModule.common.hyperlink.Hyperlink;
import com.zapps.docsReaderModule.common.pictureefftect.PictureEffectInfoFactory;
import com.zapps.docsReaderModule.common.shape.AbstractShape;
import com.zapps.docsReaderModule.common.shape.ArbitraryPolygonShape;
import com.zapps.docsReaderModule.common.shape.Arrow;
import com.zapps.docsReaderModule.common.shape.AutoShape;
import com.zapps.docsReaderModule.common.shape.GroupShape;
import com.zapps.docsReaderModule.common.shape.IShape;
import com.zapps.docsReaderModule.common.shape.LineShape;
import com.zapps.docsReaderModule.common.shape.PictureShape;
import com.zapps.docsReaderModule.common.shape.ShapeTypes;
import com.zapps.docsReaderModule.common.shape.TableCell;
import com.zapps.docsReaderModule.common.shape.TableShape;
import com.zapps.docsReaderModule.common.shape.TextBox;
import com.zapps.docsReaderModule.constant.AutoShapeConstant;
import com.zapps.docsReaderModule.constant.EventConstant;
import com.zapps.docsReaderModule.constant.MainConstant;
import com.zapps.docsReaderModule.constant.wp.WPAttrConstant;
import com.zapps.docsReaderModule.constant.wp.WPModelConstant;
import com.zapps.docsReaderModule.fc.FCKit;
import com.zapps.docsReaderModule.fc.ShapeKit;
import com.zapps.docsReaderModule.fc.hslf.HSLFSlideShow;
import com.zapps.docsReaderModule.fc.hslf.model.Fill;
import com.zapps.docsReaderModule.fc.hslf.model.HeadersFooters;
import com.zapps.docsReaderModule.fc.hslf.model.Line;
import com.zapps.docsReaderModule.fc.hslf.model.MasterSheet;
import com.zapps.docsReaderModule.fc.hslf.model.Notes;
import com.zapps.docsReaderModule.fc.hslf.model.Shape;
import com.zapps.docsReaderModule.fc.hslf.model.ShapeGroup;
import com.zapps.docsReaderModule.fc.hslf.model.Sheet;
import com.zapps.docsReaderModule.fc.hslf.model.SimpleShape;
import com.zapps.docsReaderModule.fc.hslf.model.Slide;
import com.zapps.docsReaderModule.fc.hslf.model.SlideMaster;
import com.zapps.docsReaderModule.fc.hslf.model.TextShape;
import com.zapps.docsReaderModule.fc.hslf.model.TitleMaster;
import com.zapps.docsReaderModule.fc.hslf.record.BinaryTagDataBlob;
import com.zapps.docsReaderModule.fc.hslf.record.ClientVisualElementContainer;
import com.zapps.docsReaderModule.fc.hslf.record.DocumentAtom;
import com.zapps.docsReaderModule.fc.hslf.record.OEPlaceholderAtom;
import com.zapps.docsReaderModule.fc.hslf.record.PositionDependentRecordContainer;
import com.zapps.docsReaderModule.fc.hslf.record.Record;
import com.zapps.docsReaderModule.fc.hslf.record.SlideAtom;
import com.zapps.docsReaderModule.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.zapps.docsReaderModule.fc.hslf.record.SlideProgBinaryTagContainer;
import com.zapps.docsReaderModule.fc.hslf.record.SlideProgTagsContainer;
import com.zapps.docsReaderModule.fc.hslf.record.SlideShowSlideInfoAtom;
import com.zapps.docsReaderModule.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeColorBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeCommandBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeEffectBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeMotionBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeNodeAttributeContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeNodeContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeRotationBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeScaleBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeSetBehaviorContainer;
import com.zapps.docsReaderModule.fc.hslf.record.TimeVariant;
import com.zapps.docsReaderModule.fc.hslf.record.VisualShapeAtom;
import com.zapps.docsReaderModule.fc.hslf.usermodel.PictureData;
import com.zapps.docsReaderModule.fc.hslf.usermodel.RichTextRun;
import com.zapps.docsReaderModule.fc.hslf.usermodel.SlideShow;
import com.zapps.docsReaderModule.fc.ppt.bulletnumber.BulletNumberManage;
import com.zapps.docsReaderModule.java.awt.Dimension;
import com.zapps.docsReaderModule.java.awt.Rectangle;
import com.zapps.docsReaderModule.java.awt.Rectanglef;
import com.zapps.docsReaderModule.java.awt.geom.Rectangle2D;
import com.zapps.docsReaderModule.pg.animate.ShapeAnimation;
import com.zapps.docsReaderModule.pg.model.PGModel;
import com.zapps.docsReaderModule.pg.model.PGNotes;
import com.zapps.docsReaderModule.pg.model.PGSlide;
import com.zapps.docsReaderModule.simpletext.font.FontTypefaceManage;
import com.zapps.docsReaderModule.simpletext.model.AttrManage;
import com.zapps.docsReaderModule.simpletext.model.IAttributeSet;
...
import com.zapps.docsReaderModule.simpletext.model.SectionElement;
import com.zapps.docsReaderModule.ss.util.format.NumericFormatter;
import com.zapps.docsReaderModule.system.AbstractReader;
import com.zapps.docsReaderModule.system.BackReaderThread;
...
{   
    ...
    private com.zapps.docsReaderModule.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.zapps.docsReaderModule.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.zapps.docsReaderModule.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.zapps.docsReaderModule.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.zapps.docsReaderModule.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.zapps.docsReaderModule.java.awt.Color fillColor = fill.getForegroundColor();
            	com.zapps.docsReaderModule.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.zapps.docsReaderModule.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.zapps.docsReaderModule.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.zapps.docsReaderModule.fc.hslf.model.Freeform
            || shape instanceof com.zapps.docsReaderModule.fc.hslf.model.AutoShape
            || shape instanceof com.zapps.docsReaderModule.fc.hslf.model.TextBox
            || shape instanceof com.zapps.docsReaderModule.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.zapps.docsReaderModule.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.zapps.docsReaderModule.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.zapps.docsReaderModule.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.zapps.docsReaderModule.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.zapps.docsReaderModule.fc.hslf.model.AutoShape
                    || shape instanceof com.zapps.docsReaderModule.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.zapps.docsReaderModule.fc.hslf.model.Picture)
            {   
                com.zapps.docsReaderModule.fc.hslf.model.Picture poiPic = (com.zapps.docsReaderModule.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.zapps.docsReaderModule.fc.hslf.model.Table)
        {
            com.zapps.docsReaderModule.fc.hslf.model.Table poiTable = (com.zapps.docsReaderModule.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.zapps.docsReaderModule.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.zapps.docsReaderModule.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.zapps.docsReaderModule.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.zapps.docsReaderModule.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.zapps.docsReaderModule.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.zapps.docsReaderModule.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.zapps.docsReaderModule.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.zapps.docsReaderModule.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.zapps.docsReaderModule.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
