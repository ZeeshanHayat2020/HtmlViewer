...
import com.zapps.docsReaderModule.fc.hpsf.DocumentSummaryInformation;
import com.zapps.docsReaderModule.fc.hpsf.MutablePropertySet;
import com.zapps.docsReaderModule.fc.hpsf.PropertySet;
import com.zapps.docsReaderModule.fc.hpsf.PropertySetFactory;
import com.zapps.docsReaderModule.fc.hpsf.SummaryInformation;
...
import com.zapps.docsReaderModule.fc.poifs.filesystem.DocumentInputStream;
import com.zapps.docsReaderModule.fc.poifs.filesystem.Entry;
import com.zapps.docsReaderModule.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.zapps.docsReaderModule.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.zapps.docsReaderModule.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.zapps.docsReaderModule.fc.hpsf.WritingNotSupportedException wnse)
        {
