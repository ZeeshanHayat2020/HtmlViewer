 ...
 * @author Yegor Kozlov
 */
public final class ShapeTypes implements com.zapps.docsReaderModule.common.shape.ShapeTypes
{
    /**
    ...
    static
    {
        ...
        try
        {
            Field[] f = com.zapps.docsReaderModule.common.shape.ShapeTypes.class.getFields();
