...
package com.zapps.docsReaderModule.fc.hslf.usermodel;
...
import com.zapps.docsReaderModule.fc.hslf.exceptions.CorruptPowerPointFileException;
import com.zapps.docsReaderModule.fc.hslf.model.HeadersFooters;
import com.zapps.docsReaderModule.fc.hslf.model.Hyperlink;
import com.zapps.docsReaderModule.fc.hslf.model.MovieShape;
...
import com.zapps.docsReaderModule.fc.hslf.record.Document;
import com.zapps.docsReaderModule.fc.hslf.record.DocumentAtom;
import com.zapps.docsReaderModule.fc.hslf.record.ExAviMovie;
import com.zapps.docsReaderModule.fc.hslf.record.ExControl;
import com.zapps.docsReaderModule.fc.hslf.record.ExHyperlink;
import com.zapps.docsReaderModule.fc.hslf.record.ExHyperlinkAtom;
import com.zapps.docsReaderModule.fc.hslf.record.ExMCIMovie;
import com.zapps.docsReaderModule.fc.hslf.record.ExObjList;
import com.zapps.docsReaderModule.fc.hslf.record.ExObjListAtom;
import com.zapps.docsReaderModule.fc.hslf.record.ExOleObjAtom;
import com.zapps.docsReaderModule.fc.hslf.record.ExVideoContainer;
import com.zapps.docsReaderModule.fc.hslf.record.ExtendedParagraphHeaderAtom;
import com.zapps.docsReaderModule.fc.hslf.record.ExtendedPresRuleContainer;
import com.zapps.docsReaderModule.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.zapps.docsReaderModule.fc.hslf.record.FontCollection;
import com.zapps.docsReaderModule.fc.hslf.record.HeadersFootersContainer;
import com.zapps.docsReaderModule.fc.hslf.record.PersistPtrHolder;
import com.zapps.docsReaderModule.fc.hslf.record.PositionDependentRecord;
...
import com.zapps.docsReaderModule.fc.hslf.record.RecordContainer;
import com.zapps.docsReaderModule.fc.hslf.record.RecordTypes;
import com.zapps.docsReaderModule.fc.hslf.record.SlideListWithText;
import com.zapps.docsReaderModule.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import com.zapps.docsReaderModule.fc.hslf.record.SlidePersistAtom;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof com.zapps.docsReaderModule.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((com.zapps.docsReaderModule.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof com.zapps.docsReaderModule.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((com.zapps.docsReaderModule.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
        com.zapps.docsReaderModule.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new com.zapps.docsReaderModule.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.zapps.docsReaderModule.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.zapps.docsReaderModule.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof com.zapps.docsReaderModule.fc.hslf.record.Notes)
                {
                    com.zapps.docsReaderModule.fc.hslf.record.Notes notesRecord = (com.zapps.docsReaderModule.fc.hslf.record.Notes)r;
            ...
            notesRecords = new com.zapps.docsReaderModule.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
        com.zapps.docsReaderModule.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new com.zapps.docsReaderModule.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.zapps.docsReaderModule.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof com.zapps.docsReaderModule.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (com.zapps.docsReaderModule.fc.hslf.record.Slide)r;
                }
                /*else
                {
