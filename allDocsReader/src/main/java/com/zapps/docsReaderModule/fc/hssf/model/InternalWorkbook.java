...
package com.zapps.docsReaderModule.fc.hssf.model;

import com.zapps.docsReaderModule.fc.ddf.EscherBSERecord;
import com.zapps.docsReaderModule.fc.ddf.EscherBoolProperty;
import com.zapps.docsReaderModule.fc.ddf.EscherContainerRecord;
import com.zapps.docsReaderModule.fc.ddf.EscherDgRecord;
import com.zapps.docsReaderModule.fc.ddf.EscherDggRecord;
import com.zapps.docsReaderModule.fc.ddf.EscherOptRecord;
import com.zapps.docsReaderModule.fc.ddf.EscherProperties;
import com.zapps.docsReaderModule.fc.ddf.EscherRGBProperty;
import com.zapps.docsReaderModule.fc.ddf.EscherRecord;
import com.zapps.docsReaderModule.fc.ddf.EscherSimpleProperty;
import com.zapps.docsReaderModule.fc.ddf.EscherSpRecord;
import com.zapps.docsReaderModule.fc.ddf.EscherSplitMenuColorsRecord;
import com.zapps.docsReaderModule.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import com.zapps.docsReaderModule.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
import com.zapps.docsReaderModule.fc.hssf.formula.FormulaShifter;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.Area3DPtg;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.NameXPtg;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.OperandPtg;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.Ptg;
import com.zapps.docsReaderModule.fc.hssf.formula.ptg.Ref3DPtg;
import com.zapps.docsReaderModule.fc.hssf.formula.udf.UDFFinder;
import com.zapps.docsReaderModule.fc.hssf.record.BOFRecord;
import com.zapps.docsReaderModule.fc.hssf.record.BackupRecord;
import com.zapps.docsReaderModule.fc.hssf.record.BookBoolRecord;
import com.zapps.docsReaderModule.fc.hssf.record.BoundSheetRecord;
import com.zapps.docsReaderModule.fc.hssf.record.CodepageRecord;
import com.zapps.docsReaderModule.fc.hssf.record.CountryRecord;
import com.zapps.docsReaderModule.fc.hssf.record.DSFRecord;
import com.zapps.docsReaderModule.fc.hssf.record.DateWindow1904Record;
import com.zapps.docsReaderModule.fc.hssf.record.DrawingGroupRecord;
import com.zapps.docsReaderModule.fc.hssf.record.EOFRecord;
import com.zapps.docsReaderModule.fc.hssf.record.EscherAggregate;
import com.zapps.docsReaderModule.fc.hssf.record.ExtSSTRecord;
import com.zapps.docsReaderModule.fc.hssf.record.ExtendedFormatRecord;
import com.zapps.docsReaderModule.fc.hssf.record.ExternSheetRecord;
import com.zapps.docsReaderModule.fc.hssf.record.FileSharingRecord;
import com.zapps.docsReaderModule.fc.hssf.record.FnGroupCountRecord;
import com.zapps.docsReaderModule.fc.hssf.record.FontRecord;
import com.zapps.docsReaderModule.fc.hssf.record.FormatRecord;
import com.zapps.docsReaderModule.fc.hssf.record.HideObjRecord;
import com.zapps.docsReaderModule.fc.hssf.record.HyperlinkRecord;
import com.zapps.docsReaderModule.fc.hssf.record.InterfaceEndRecord;
import com.zapps.docsReaderModule.fc.hssf.record.InterfaceHdrRecord;
import com.zapps.docsReaderModule.fc.hssf.record.MMSRecord;
import com.zapps.docsReaderModule.fc.hssf.record.NameCommentRecord;
import com.zapps.docsReaderModule.fc.hssf.record.NameRecord;
import com.zapps.docsReaderModule.fc.hssf.record.PaletteRecord;
import com.zapps.docsReaderModule.fc.hssf.record.PasswordRecord;
import com.zapps.docsReaderModule.fc.hssf.record.PasswordRev4Record;
import com.zapps.docsReaderModule.fc.hssf.record.PrecisionRecord;
import com.zapps.docsReaderModule.fc.hssf.record.ProtectRecord;
import com.zapps.docsReaderModule.fc.hssf.record.ProtectionRev4Record;
import com.zapps.docsReaderModule.fc.hssf.record.RecalcIdRecord;
import com.zapps.docsReaderModule.fc.hssf.record.Record;
import com.zapps.docsReaderModule.fc.hssf.record.RefreshAllRecord;
import com.zapps.docsReaderModule.fc.hssf.record.SSTRecord;
import com.zapps.docsReaderModule.fc.hssf.record.StyleRecord;
import com.zapps.docsReaderModule.fc.hssf.record.SupBookRecord;
import com.zapps.docsReaderModule.fc.hssf.record.TabIdRecord;
import com.zapps.docsReaderModule.fc.hssf.record.UseSelFSRecord;
import com.zapps.docsReaderModule.fc.hssf.record.WindowOneRecord;
import com.zapps.docsReaderModule.fc.hssf.record.WindowProtectRecord;
import com.zapps.docsReaderModule.fc.hssf.record.WriteAccessRecord;
import com.zapps.docsReaderModule.fc.hssf.record.WriteProtectRecord;
import com.zapps.docsReaderModule.fc.hssf.record.common.UnicodeString;
import com.zapps.docsReaderModule.fc.hssf.util.HSSFColor;
import com.zapps.docsReaderModule.fc.ss.usermodel.BuiltinFormats;
import com.zapps.docsReaderModule.fc.util.Internal;
import com.zapps.docsReaderModule.fc.util.POILogFactory;
import com.zapps.docsReaderModule.fc.util.POILogger;
import com.zapps.docsReaderModule.system.AbortReaderError;
 ...
 * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.record.SSTRecord
     */
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.record.BoundSheetRecord
     * @see com.zapps.docsReaderModule.fc.hssf.record.Record
     */
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.record.FormatRecord
     * @see com.zapps.docsReaderModule.fc.hssf.record.Record
     */
    ...
    */
     ...
     *
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
