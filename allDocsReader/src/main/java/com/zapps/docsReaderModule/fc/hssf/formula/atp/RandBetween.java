...
==================================================================== */
package com.zapps.docsReaderModule.fc.hssf.formula.atp;


import com.zapps.docsReaderModule.fc.hssf.formula.OperationEvaluationContext;
...
final class RandBetween implements FreeRefFunction{
	 ...
	 * than top.
	 * 
	 * @see com.zapps.docsReaderModule.fc.hssf.formula.function.FreeRefFunction#evaluate(com.zapps.docsReaderModule.fc.hssf.formula.eval.ValueEval[], com.zapps.docsReaderModule.fc.hssf.formula.OperationEvaluationContext)
	 */
