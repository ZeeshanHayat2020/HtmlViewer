...
import com.zapps.docsReaderModule.common.bookmark.Bookmark;
import com.zapps.docsReaderModule.common.borders.Border;
import com.zapps.docsReaderModule.common.borders.Borders;
import com.zapps.docsReaderModule.common.borders.Line;
import com.zapps.docsReaderModule.common.bulletnumber.ListData;
import com.zapps.docsReaderModule.common.bulletnumber.ListLevel;
import com.zapps.docsReaderModule.common.hyperlink.Hyperlink;
import com.zapps.docsReaderModule.common.picture.Picture;
...
import com.zapps.docsReaderModule.common.shape.WPAbstractShape;
import com.zapps.docsReaderModule.common.shape.WPAutoShape;
import com.zapps.docsReaderModule.common.shape.WPGroupShape;
import com.zapps.docsReaderModule.common.shape.WPPictureShape;
...
import com.zapps.docsReaderModule.fc.ddf.EscherTextboxRecord;
import com.zapps.docsReaderModule.fc.hwpf.HWPFDocument;
import com.zapps.docsReaderModule.fc.hwpf.model.FieldsDocumentPart;
import com.zapps.docsReaderModule.fc.hwpf.model.ListFormatOverride;
import com.zapps.docsReaderModule.fc.hwpf.model.ListTables;
import com.zapps.docsReaderModule.fc.hwpf.model.POIListData;
import com.zapps.docsReaderModule.fc.hwpf.model.POIListLevel;
import com.zapps.docsReaderModule.fc.hwpf.model.PicturesTable;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.Bookmarks;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.BorderCode;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.CharacterRun;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.Field;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.HWPFAutoShape;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.HWPFShape;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.HWPFShapeGroup;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.HeaderStories;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.InlineWordArt;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.OfficeDrawing;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.OfficeDrawings;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.POIBookmark;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.Paragraph;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.PictureType;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.Range;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.Section;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.Table;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.TableCell;
import com.zapps.docsReaderModule.fc.hwpf.usermodel.TableRow;
import com.zapps.docsReaderModule.fc.util.LittleEndian;
import com.zapps.docsReaderModule.java.awt.Rectangle;
import com.zapps.docsReaderModule.java.util.Arrays;
...
import com.zapps.docsReaderModule.simpletext.view.PageAttr;
import com.zapps.docsReaderModule.ss.util.ModelUtil;
import com.zapps.docsReaderModule.system.AbstractReader;
import com.zapps.docsReaderModule.system.IControl;
import com.zapps.docsReaderModule.wp.model.CellElement;
import com.zapps.docsReaderModule.wp.model.HFElement;
import com.zapps.docsReaderModule.wp.model.RowElement;
import com.zapps.docsReaderModule.wp.model.TableElement;
import com.zapps.docsReaderModule.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.zapps.docsReaderModule.java.awt.Color fillColor = shape.getForegroundColor();
            	com.zapps.docsReaderModule.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.zapps.docsReaderModule.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.zapps.docsReaderModule.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
