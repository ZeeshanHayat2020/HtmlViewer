 ...
 * 时间:              下午1:55:20
 */
package com.zapps.docsReaderModule.ss.model.XLSModel;
...
import com.zapps.docsReaderModule.common.shape.AChart;
...
import com.zapps.docsReaderModule.constant.SSConstant;
import com.zapps.docsReaderModule.fc.hssf.model.InternalSheet;
import com.zapps.docsReaderModule.fc.hssf.model.InternalWorkbook;
import com.zapps.docsReaderModule.fc.hssf.record.BlankRecord;
...
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFAutoShape;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFChart;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFChildAnchor;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFClientAnchor;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFFreeform;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFLine;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFPatriarch;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFPicture;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFPictureData;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFRichTextString;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFShape;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFShapeGroup;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFSheet;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFTextbox;
import com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFWorkbook;
...
import com.zapps.docsReaderModule.fc.xls.ChartConverter;
import com.zapps.docsReaderModule.java.awt.Rectangle;
import com.zapps.docsReaderModule.ss.model.CellRangeAddress;
import com.zapps.docsReaderModule.ss.model.baseModel.Cell;
import com.zapps.docsReaderModule.ss.model.baseModel.Row;
import com.zapps.docsReaderModule.ss.model.baseModel.Sheet;
import com.zapps.docsReaderModule.ss.model.baseModel.Workbook;
import com.zapps.docsReaderModule.ss.model.drawing.AnchorPoint;
import com.zapps.docsReaderModule.ss.model.drawing.CellAnchor;
import com.zapps.docsReaderModule.ss.model.sheetProperty.PaneInformation;
import com.zapps.docsReaderModule.ss.util.ModelUtil;
import com.zapps.docsReaderModule.ss.util.SectionElementFactory;
...
import com.zapps.docsReaderModule.thirdpart.achartengine.chart.AbstractChart;
import com.zapps.docsReaderModule.thirdpart.achartengine.chart.RoundChart;
import com.zapps.docsReaderModule.thirdpart.achartengine.chart.XYChart;
import com.zapps.docsReaderModule.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.zapps.docsReaderModule.fc.ss.usermodel.Sheet
{
     ...
     * @see com.zapps.docsReaderModule.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.zapps.docsReaderModule.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.zapps.docsReaderModule.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.zapps.docsReaderModule.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.zapps.docsReaderModule.ss.model.sheetProperty.ColumnInfo columnInfo = new com.zapps.docsReaderModule.ss.model.sheetProperty.ColumnInfo(
