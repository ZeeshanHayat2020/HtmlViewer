...
package com.zapps.docsReaderModule.ss.model;
...
import com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor;
...
public final class ClientAnchor extends Anchor implements IClientAnchor
{
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#getCol1()
     *
     */
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#setCol1(int)
     *
     */
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#getCol2()
     *
     */
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#setCol2(int)
     *
     */
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#getRow1()
     *
     */
    public int getRow1()
    {
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#setRow1(int)
     *
     */
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#getRow2()
     *
     */
    public int getRow2()
    {
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.ss.model.interfacePart.IClientAnchor#setRow2(int)
     *
     */
