...
import com.zapps.docsReaderModule.system.AbstractControl;
    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new com.zapps.docsReaderModule.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
...
//            safeAsyncTask.execute((Void)null);
     ...
     * 
     *(non-Javadoc)
     * @see com.zapps.docsReaderModule.system.AbstractControl#getActivity()
     *
     */
